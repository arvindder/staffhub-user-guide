...
![Leave Period](_static/leave-period.png)

## 3. Granting leave using Leave Period

> In version 12, leaves could be granted via Leave Period through the "Grant Leaves" button.
...
The **Grant** button will generate Leave Allocations based on the [Leave Policy]() applicable to each Employee. You can allocate leaves based on [Employee Grade]() as shown below.

![Leave Period](_static/grant-button.gif)
